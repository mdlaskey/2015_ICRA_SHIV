...
With such algorithms, the number of mistakes has indeed been proven to scale only linearly with the time horizon, as opposed to quadratically \cite{}. DAgger and related algorithms have seen a wide range of applications, from quadrotor flight to natural language to Atari games~\cite{NIPS2014_5421,duvallet2013imitation,ross2013learning}.
...
\begin{figure}[t!]
\centering
\includegraphics[width=8cm, height=6cm]{figures/race_car.png}
